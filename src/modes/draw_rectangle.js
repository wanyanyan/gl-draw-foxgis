    ...
    start:function(){
      ...
      this.on('mousemove', CommonSelectors.true, function(e){
        if(currentVertexPosition === 2){
          var rectVertex = rectangle.getRectVertex(e.lngLat);
          if(rectVertex){
            rectangle.updateCoordinate("0.2", rectVertex[2][0], rectVertex[2][1]);
            rectangle.updateCoordinate("0.3", rectVertex[3][0], rectVertex[3][1]);
          }
