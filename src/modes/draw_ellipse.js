...
const Ellipse = require('../feature_types/ellipse');
...
module.exports = function(ctx) {
    ...
    const circle = new Ellipse(ctx, {
        type: Constants.geojsonTypes.FEATURE,
        properties: {
            type: Constants.featureTypes.Ellipse
        },
        geometry: {
        ...
        start: function() {
            ...
            this.on('mousemove', CommonSelectors.true, function(e) {
                if (currentClickNum === 1) {
                    var circleVertex = circle.getEllipseVertex(ctx, center, ctx.map.project(e.lngLat));
                    if (circleVertex) {
