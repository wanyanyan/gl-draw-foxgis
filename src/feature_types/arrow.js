...
Arrow.prototype.getArrowVertex = function(ctx,p1,p2) {
	...
	var sina = -(p2.x-p1.x)/p1_p2;//旋转角度的正玄值
	var cosa = (p2.y-p1.y)/p1_p2;
	var innerR = Math.sqrt(innerOffset*innerOffset+(p1_p2-topOffset)*(p1_p2-topOffset));
	var outerR = Math.sqrt(outerOffset*outerOffset+(p1_p2-topOffset)*(p1_p2-topOffset));
